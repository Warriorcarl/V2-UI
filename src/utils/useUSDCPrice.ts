import { ChainId, Currency, currencyEquals, JSBI, Price, WETH } from '@warriorcarl/sdk'
...
export default function useUSDCPrice(currency?: Currency): Price | undefined {
  ...
  const tokenPairs: [Currency | undefined, Currency | undefined][] = useMemo(
    () => [
      ...
      [wrapped?.equals(USDC) ? undefined : wrapped, chainId === ChainId.HELIOS ? USDC : undefined],
      [chainId ? WETH[chainId] : undefined, chainId === ChainId.HELIOS ? USDC : undefined]
    ],
